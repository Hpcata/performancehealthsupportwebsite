                        ...
                        <div class="dialog-main-view">
                                    ...
                                    <div class="dialog-actions">
                                        <button class="snap-btn hover-card">
                                            <img
                                                ...
                                                " />
                                            Snap
                                            <span style="margin-left: 4px;display: flex;align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="13" viewBox="0 0 15 13" fill="none" style="margin-right: 4px">
                                                    <path d="M7.87326 0.360751C7.78906 0.190078 7.6152 0.0820312 7.42486 0.0820312C7.2346 0.0820312 7.06073 0.190078 6.97653 0.360751L5.20705 3.9461L1.25038 4.52104C1.06204 4.54841 0.905565 4.68033 0.846752 4.86133C0.787938 5.04234 0.836992 5.24104 0.973278 5.37389L3.83634 8.1647L3.16046 12.1054C3.1283 12.293 3.2054 12.4825 3.35938 12.5944C3.51335 12.7063 3.71748 12.721 3.88594 12.6324L7.42486 10.7719L10.9639 12.6324C11.1323 12.721 11.3365 12.7063 11.4904 12.5944C11.6444 12.4825 11.7215 12.293 11.6893 12.1054L11.0135 8.1647L13.8765 5.37389C14.0128 5.24104 14.0619 5.04234 14.0031 4.86133C13.9442 4.68033 13.7877 4.54841 13.5994 4.52104L9.64273 3.9461L7.87326 0.360751Z" fill="#EF7F00" />
                                                </svg>0</span>
                                        </button>
                                        <button class="share-btn hover-card"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                                                <g clip-path="url(#clip0_2686_6373)">
                                                    <path d="M1.00391 8.99692V14.9757C1.00391 15.3721 1.19638 15.7523 1.53898 16.0326C1.88158 16.3129 2.34625 16.4704 2.83076 16.4704H13.7919C14.2764 16.4704 14.741 16.3129 15.0836 16.0326C15.4262 15.7523 15.6187 15.3721 15.6187 14.9757V8.99692M11.965 4.51283L8.31131 1.52344M8.31131 1.52344L4.65761 4.51283M8.31131 1.52344V11.239" stroke="#3B3B3B" stroke-width="1.43864" stroke-linecap="round" stroke-linejoin="round" />
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0_2686_6373">
                                                        <rect width="16.4417" height="16.4417" fill="white" transform="translate(0.0898438 0.777344)" />
                                                    </clipPath>
                                                </defs>
                                            </svg>Share</button>
                                    </div>
                            ...
                            <div class="dialog-body">
                                ...
                                <div class="nutrition-info">
                                    ...
                                    <span style="color: #eb4c60">● <span style="color:rgba(59, 59, 59, 1)">Protein: 0 g</span></span>
                                    <span style="color: #f1b020">● <span style="color:rgba(59, 59, 59, 1)">Carb: 0 g</span></span>
                                    <span style="color: #659cf1">● <span style="color:rgba(59, 59, 59, 1)">Fat: 0 g</span></span>
                                </div>
                                ...
                                <div class="dialog-actions mobile-responsive">
                                    ...
                                    <button class="share-btn"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                                            <g clip-path="url(#clip0_2686_6373)">
                                                <path d="M1.00391 8.99692V14.9757C1.00391 15.3721 1.19638 15.7523 1.53898 16.0326C1.88158 16.3129 2.34625 16.4704 2.83076 16.4704H13.7919C14.2764 16.4704 14.741 16.3129 15.0836 16.0326C15.4262 15.7523 15.6187 15.3721 15.6187 14.9757V8.99692M11.965 4.51283L8.31131 1.52344M8.31131 1.52344L4.65761 4.51283M8.31131 1.52344V11.239" stroke="#3B3B3B" stroke-width="1.43864" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
