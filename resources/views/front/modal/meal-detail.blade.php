                                ...
                                <div class="" >
                                    ...
                                    <div class="dialog-actions">
                                        <button class="snap-btn">
                                            ...
                                            <span style="margin-left: 4px;display: flex;
    align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="13" viewBox="0 0 15 13" fill="none" style="margin-right: 4px">
