...
<div id="print-shopping-list-modal" style="display: none; position: fixed; z-index: 10000; left: 0; top: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.5);">
    <div style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); background: #fff; border-radius: 16px; width: 90vw; max-width: 800px; max-height: 90vh; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.18); padding: 0; display: flex; flex-direction: column;">
        ...
        <div style="padding: 0 24px 18px 0; display: flex; justify-content: flex-end; align-items: center;">
            <button id="download-pdf" style="background: #2a5ca4; color: #fff; border: none; border-radius: 8px; padding: 12px 28px; font-size: 1rem; font-weight: 500; cursor: pointer; box-shadow: 0 2px 8px rgba(42, 92, 164, 0.08);">Download PDF</button>
        </div>
    </div>
</div>
