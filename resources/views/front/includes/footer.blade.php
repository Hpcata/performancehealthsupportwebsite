...
@elseif(Route::is('front.sub-home-page') && false)
<footer class="footer-bg">
    <div class="container footer-grid">
      ...
      <div class="navbar-brand">
        ...
        <a href="#" class="social-icon mb-auto">
          <!-- LinkedIn Icon -->
        ...
        <p class="copyright-text mob-hide">
          Copyright {{ date('Y') }} Catalysta Pty Ltd
        </p>
      </div>
      ...
      <nav class="nav-links">
        ...
        <div class="dropdown">
          <a class="footer-link dropdown-toggle" href="#" role="button" id="servicesDropdown" data-bs-toggle="dropdown"
            aria-expanded="false">
            Services
          </a>
          <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
            ...
            <li>
              <a class="dropdown-item" href="#">Competition plan</a>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item" href="#">Consults</a>
            </li>
          </ul>
        </div>
      ...
      <div class="buttons-desktop">
        ...
        @else
          <button class="btn btn-login mob-hide" data-bs-toggle="modal" data-bs-target="#loginModal">Log in</button>
      ...
      <div class="buttons-mobile">
        ...
        @else
          <button type="button" class="btn btn-login rounded-md" data-bs-toggle="modal" data-bs-target="#loginModal">Log in</button>
          <button type="button" class="btn btn-signup rounded-md" data-bs-toggle="modal" data-bs-target="#signupModal">
            Sign up for free
          </button>
        @endif
      </div>
