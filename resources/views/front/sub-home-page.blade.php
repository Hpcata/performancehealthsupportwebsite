...
@section('content')
    ...
    @if(isset($page->sections))
        @foreach($page->sections as $section)
            @if($section->type == 'section-1' && $section->enabled == 1)
                <div class="section nutrition-page-banner pt-md-5"
                    style="background-image: url(private/public/front/images/hero-img-03.webp);">
                    <div class="container">
                        ...
                        <div class="text-center banner-text mt-auto pt-5">
                            ...
                            <a href="#" class="btn btn-primary" id="takeFreeTest">
                                ...
                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M11.2203 10.9062L11.3313 1.14895L1.57769 1.43685M10.2334 2.26696L0.821276 11.8513"
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-sm">
                                    <svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"
                                        ...
                                        <path
                                            d="M23.6,22l-4.4-4.4c1.5-1.8,2.4-4.2,2.4-6.7c0-6-4.8-10.8-10.8-10.8C4.8,0,0,4.8,0,10.8c0,6,4.8,10.8,10.8,10.8c2.5,0,4.9-0.9,6.7-2.4l4.4,4.4c0.2,0.2,0.5,0.4,0.8,0.4c0.3,0,0.6-0.1,0.8-0.4C24.1,23.2,24.1,22.4,23.6,22z M2.4,10.8c0-4.6,3.8-8.4,8.4-8.4c4.6,0,8.4,3.8,8.4,8.4c0,2.3-0.9,4.4-2.4,5.9c0,0,0,0,0,0c0,0,0,0,0,0c-1.5,1.5-3.6,2.4-5.9,2.4C6.2,19.2,2.4,15.4,2.4,10.8z">
                                        </path>
                                    </svg>
                                    Search
                                </button>
                                ...
                                <div data-aos="fade-up" class="aos-init aos-animate">
                                    @if($isAuthenticated && in_array($plan->id, $planIds))
                                        ...
                                        $isPlanCreated = $userPlan ? true : false;
                                                                    ?>
                                                            <a href="{{ route('front.plans.details', ['id' => $plan->id, 'user_id' => Auth::user()->id]) }}"
                                                                class="btn btn-primary mt-2 w-100 @if(!$isPlanCreated) disabled @endif"
                                                                @if(!$isPlanCreated) style="pointer-events: none; opacity: 0.5;" @endif>
    ...
    <div class="section bg-white py-5" id="sample-plan-section">
                        ...
                        <div class="row flex-row-reverse align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="nutrition-login-form mt-4 mt-md-0">
                                    ...
                                    <p>Personalised nutrition and fitness plans to help you stay strong, energised, and at
                                        your best every day.</p>
                                    <button type="button" class="btn btn-primary sample-plan-modal" data-bs-toggle="modal"
                                        data-bs-target="#sample-plan-modal">
                                        View More Features
                                    </button>

                                    <div class="modal fade" id="sample-plan-modal" tabindex="-1"
                                        aria-labelledby="smplPlnModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    data-bs-target="#createProfile" aria-expanded="false"
                                                                    aria-controls="flush-collapseOne">
                                                                    Create a Profile
                                                                </button>
                                                            </h2>
                                                            <div id="createProfile" class="accordion-collapse collapse"
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>Your specific health profile data is used
                                                                                    to customise a nutrition plan based on
                                                                                    individual training and competition
                                                                                    needs.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/create-profile-img-01.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                <h3>Goals</h3>
                                                                                <p>Select nutrition related goals (improved
                                                                                    sports performance/recovery, muscle
                                                                                    gain, weight loss, injury repair etc).
                                                                                    Progress is tracked with key actions.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/goal-img-01.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse" data-bs-target="#history"
                                                                    aria-expanded="false" aria-controls="flush-collapseOne">
                                                                    History
                                                                </button>
                                                            </h2>
                                                            <div id="history" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>Nutrition + Medical History
                                                                                    Dietary preferences, supplement use, and
                                                                                    medical screening information are
                                                                                    recorded.
                                                                                    You can also create your own 'BioHealth
                                                                                    Passport' where blood test results and
                                                                                    scans etc can be uploaded.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/intake-img-01.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#foodPreferences" aria-expanded="false"
                                                                    aria-controls="flush-collapseOne">
                                                                    Food Preferences
                                                                </button>
                                                            </h2>
                                                            <div id="foodPreferences" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>You choose foods that you like which are
                                                                                    then used to design relevant meals and
                                                                                    snacks that align with your performance
                                                                                    goals.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/food-preferences-img-001.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse" data-bs-target="#purchasePlan"
                                                                    aria-expanded="false" aria-controls="flush-collapseOne">
                                                                    Your Purchased Plan
                                                                </button>
                                                            </h2>
                                                            <div id="purchasePlan" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>Displays the nutrition or fitness plan a
                                                                                    subscribed to, including details on
                                                                                    duration, customization options, and
                                                                                    renewal status. Helps manage their plan
                                                                                    effectively.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/your-purchased-plan-0001.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse" data-bs-target="#smartSwaps"
                                                                    aria-expanded="false" aria-controls="flush-collapseOne">
                                                                    Smart Swaps
                                                                </button>
                                                            </h2>
                                                            <div id="smartSwaps" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                <h3>Smart Swaps</h3>
                                                                                <p>You can swap ingredients within meals to
                                                                                    add variety to your plan whilst being
                                                                                    coached with nutrition tips.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/customise-your-plan-01.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#selectShopingList"
                                                                    aria-expanded="false" aria-controls="flush-collapseOne">
                                                                    Select Shopping List
                                                                </button>
                                                            </h2>
                                                            <div id="selectShopingList" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>A grocery list is created based on your
                                                                                    custom meal plan to make shopping and
                                                                                    eating much easier.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/select-shopping-list-001.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#printShoppingList"
                                                                    aria-expanded="false" aria-controls="flush-collapseOne">
                                                                    Print Shopping List
                                                                </button>
                                                            </h2>
                                                            <div id="printShoppingList" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/print-shopping-list-001.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#printSummaryPlan" aria-expanded="false"
                                                                    aria-controls="flush-collapseOne">
                                                                    Print Your Summary Plan
                                                                </button>
                                                            </h2>
                                                            <div id="printSummaryPlan" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                ...
                                                                                <p>Print Your Plan and get cracking on
                                                                        ...
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/print-your-summery-plan-002.jpeg') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="flush-headingOne">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#competitionPlan" aria-expanded="false"
                                                                    aria-controls="flush-collapseOne">
                                                                    Competition + Injury / Surgery Plans
                                                                </button>
                                                            </h2>
                                                            <div id="competitionPlan" class="accordion-collapse collapse"
                                                                aria-labelledby="flush-headingOne"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-5 col-lg-4">
                                                                            <div class="sample-content">
                                                                                <h3>Competition + Injury / Surgery Plans
                                                                                </h3>
                                                                                <p>Whether you're getting organised for a
                                                                                    comp or recovering from injury, a custom
                                                                                    nutrition plan will ensure your
                                                                                    nutrition is optimised for peak
                                                                                    performance or fast healing.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-7 col-lg-8">
                                                                            <div class="sample-img">
                                                                                <figure>
                                                                                    <img src="{{ frontAssets('images/competition-plan-01.webp') }}"
                                                                                        alt="">
                                                                                </figure>
                                                                            </div>
                                                                        </div>
                            ...
                            <div class="row flex-row-reverse align-items-center">
                                <div class="col-md-6">
                                    <div class="nutrition-login-images p-0">
                                        <div class="nutrition-login-big">
                                            <figure class="w-100">
                                                <img src="{{ frontAssets('images/nutrition-login-plans-big.webp') }}"
                                                    alt="">
                                            </figure>
                                        </div>
                                        <!-- <div class="nutrition-login-small">
                                ...
                                <div class="card-body p-4">
                                    <div class="p-md-3 row">
                                        <div class="col-lg-6">
                                            ...
                                            <figure>
                                                <img src="https://booking.biohealthpassport.com.au/public/uploads/front_logo/1727981512_1727875441_logo.png"
                                                    alt="">
                                            </figure>
                                            <h3>Get answers from a real-life expert. Not a chat bot.</h3>
                                            <a href="https://booking.biohealthpassport.com.au/kerry-obryan"
                                                class="btn btn-white">Book Now
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M6.4165 15.5827L15.5832 6.41602M15.5832 6.41602H6.4165M15.5832 6.41602V15.5827"
                                                        stroke="#124E4D" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                </svg>
                                            </a>
                                        </div>
                    ...
                    <div class="row justify-content-between align-items-start">
                        ...
                        <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <form id="query-form">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control" id="query-email"
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="query-message"
                                        rows="3"></textarea>
                                ...
                                <p class="my-4" data-aos="fade-up" data-aos-delay="200"><a href="#" class="btn btn-primary"
                                        id="submit-query">Submit
                                        <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="test-login-form">
                            ...
                            <div class="mb-3">
                                <label for="login-password" class="form-label">Password</label>
                                <input type="password" name="password" class="form-control" id="test-login-password"
                                    required>
                            </div>
        ...
        <div class="modal fade" id="samplePlanModal" tabindex="-1" aria-labelledby="samplePlanModalLabel"
            aria-hidden="true">
        ...
        <div class="modal fade" id="TakeTestModel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="TakeTestModelLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                        ...
                        <div class="tab-main-box">
                                ...
                                <div class="card">
                                    <div class="p-3 card-header bg-white">
                                        <div class="d-flex align-items-center">
                                            <h5 class="m-0">1. Do you think these foods are <strong
                                                    class="text-primary">high</strong> or <strong
                                                    class="text-primary">low</strong> in <strong
                                                    class="text-primary">carbohydrate</strong>? <span>(Select one answer per
                                                    food)</span></h5>
                                            <span class="ms-2 general-error-message text-danger"> </span>
                                        </div>
                                        <input type="hidden" name="questions[nutrition-Q-1]"
                                            value="Do you think these foods are high or low in carbohydrate?" />
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][chicken]" value="0" id="Chicken-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][chicken]" value="1" id="Chicken-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][chicken]" value="0" id="Chicken-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Baked beans</td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][baked_beans]" value="1"
                                                                id="Bakedbeans-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][baked_beans]" value="0"
                                                                id="Bakedbeans-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][grain_bread]" value="1"
                                                                id="GrainBread-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][grain_bread]" value="0"
                                                                id="GrainBread-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][avocado]" value="0" id="Avocado-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][avocado]" value="1" id="Avocado-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][avocado]" value="0" id="Avocado-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Weet-bix</td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][weet_bix]" value="1"
                                                                id="Weet-bix-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][weet_bix]" value="0"
                                                                id="Weet-bix-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][fruit_yoghurt]" value="1"
                                                                id="FruitYoghurt-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][fruit_yoghurt]" value="0"
                                                                id="FruitYoghurt-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][crumpets]" value="1"
                                                                id="Crumpets-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][crumpets]" value="0"
                                                                id="Crumpets-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="High"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][cream]" value="0" id="Cream-1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Low"
                                                                data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-1][cream]" value="1" id="Cream-2">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" data-option="Unsure"
                                                                data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-1][cream]" value="0" id="Cream-3">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                        <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                            target="2">Next</button>
                                    </div>
                                </div>
                            </div>
                            <div class="step-tab-box nutrition-form" id="div2" style="display: block;">
                                <div class="card">
                                    <div class="p-3 card-header bg-white">
                                        <div class="d-flex align-items-center">
                                            <h5 class="m-0">2. Do you think these foods are <strong
                                                    class="text-primary">high</strong> or <strong
                                                    class="text-primary">low</strong> in <strong
                                                    class="text-primary">protein</strong>?
                                                <span>(Select one answer per food)</span>
                                            </h5>
                                            <span class="ms-2 general-error-message text-danger"> </span>
                                        </div>
                                        <input type="hidden" name="questions[nutrition-Q-2]"
                                            value="Do you think these foods are high or low in protein?" />
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][salmon]" value="1" id="Salmon-1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][salmon]" value="0" id="Salmon-2">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][salmon]" value="0" id="Salmon-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Baked beans</td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][baked_beans]" value="1"
                                                                id="Bakedbeans-11"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][baked_beans]" value="0"
                                                                id="Bakedbeans-12"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][baked_beans]" value="0"
                                                    ...
                                                    <tr>
                                                        <td>Fruit</td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][fruit]" value="0" id="Fruit-1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][fruit]" value="1" id="Fruit-2">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][fruit]" value="0" id="Fruit-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Hummus</td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][hummus]" value="0" id="Hummus-1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][hummus]" value="1" id="Hummus-2">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][hummus]" value="0" id="Hummus-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][cornflakes_cereal]" value="0"
                                                                id="CornflakesCereal-1"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][cornflakes_cereal]" value="1"
                                                                id="CornflakesCereal-2"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][cornflakes_cereal]" value="0"
                                                                id="CornflakesCereal-3"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Almonds</td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][almonds]" value="1" id="Almonds-1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][almonds]" value="0" id="Almonds-2">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][almonds]" value="0" id="Almonds-3">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][flavoured_milk]" value="1"
                                                                id="FlavouredMilk-1"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][flavoured_milk]" value="0"
                                                                id="FlavouredMilk-2"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][flavoured_milk]" value="0"
                                                                id="FlavouredMilk-3"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Ice cream</td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][ice_cream]" value="0"
                                                                id="IceCream-1"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][ice_cream]" value="1"
                                                                id="IceCream-2"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][ice_cream]" value="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="High" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][almond_oat_milk]" value="0"
                                                                id="Almond-oat-milk-1"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Low" data-correct="1" type="radio"
                                                                name="ans[nutrition-Q-2][almond_oat_milk]" value="1"
                                                                id="Almond-oat-milk-2"></td>
                                                        <td class="text-center"><input class="form-check-input"
                                                                data-option="Unsure" data-correct="0" type="radio"
                                                                name="ans[nutrition-Q-2][almond_oat_milk]" value="0"
                                                                id="Almond-oat-milk-3"></td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                        <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                            target="1">Back</button>
                                        <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                            target="3">Next</button>
                                    </div>
                                </div>
                            </div>
                            <div class="step-tab-box nutrition-form" id="div3" style="display: block;">
                                <div class="card">
                                    <div class="p-3 card-header bg-white">
                                        <div class="d-flex align-items-center">
                                            <h5 class="m-0">3. Do you think these foods are <strong
                                                    class="text-primary">high</strong> or <strong
                                                    class="text-primary">low</strong> in <strong
                                                    class="text-primary">fat</strong>?
                                                <span>(Select one answer per food)</span>
                                            </h5>
                                            <span class="ms-2 general-error-message text-danger"> </span>
                                            <input type="hidden" name="questions[nutrition-Q-3]"
                                                value="Do you think these foods are high or low in fat?" />
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-3][avocado]" value="1" id="Avocado-11"
                                                                data-option="High" data-correct="1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-3][avocado]" value="0" id="Avocado-12"
                                                                data-option="Low" data-correct="0">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-3][avocado]" value="0" id="Avocado-13"
                                                                data-option="Unsure" data-correct="0">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="CheddarTatsyCheese-1" data-option="High"
                                                                data-correct="1">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-3][cheddar_tatsy_cheese]" value="0"
                                                                id="CheddarTatsyCheese-2" data-option="Low"
                                                                data-correct="0">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-3][cheddar_tatsy_cheese]" value="0"
                                                                id="CheddarTatsyCheese-3" data-option="Unsure"
                                                                data-correct="0">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                        <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                            target="2">Back</button>
                                        <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                            target="4">Next</button>
                                    </div>
                                </div>
                            </div>
                            <div class="step-tab-box nutrition-form" id="div4" style="display: none;">
                                <div class="card">
                                    <div class="p-3 card-header bg-white">
                                        <div class="d-flex align-items-center">
                                            <h5 class="m-0">4. Do you think these foods are <strong
                                                    class="text-primary">high</strong> or <strong
                                                    class="text-primary">low</strong> in <strong
                                                    class="text-primary">healthy fats</strong>? <span>(Select one answer per
                                                    food)</span></h5>
                                            <span class="ms-2 general-error-message text-danger"> </span>
                                        </div>
                                        <input type="hidden" name="questions[nutrition-Q-4]"
                                            value="Do you think these foods are high or low in healthy fat?" />
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][butter]" value="0" id="Butter-1"
                                                                data-option="High" data-correct="0"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][butter]" value="1" id="Butter-2"
                                                                data-option="Low" data-correct="1"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][butter]" value="0" id="Butter-3"
                                                                data-option="Unsure" data-correct="0"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Extra virgin olive oil</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][extra_virgin_olive_oil]" value="1"
                                                                id="OliveOil-1" data-option="High" data-correct="1"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][extra_virgin_olive_oil]" value="0"
                                                                id="OliveOil-2" data-option="Low" data-correct="0"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][extra_virgin_olive_oil]" value="0"
                                                                id="OliveOil-3" data-option="Unsure" data-correct="0"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Whole milk</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][whole_milk]" value="0"
                                                                id="WholeMilk-1" data-option="High" data-correct="0"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][whole_milk]" value="1"
                                                                id="WholeMilk-2" data-option="Low" data-correct="1"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][whole_milk]" value="0"
                                                                id="WholeMilk-3" data-option="Unsure" data-correct="0"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Potato crisps</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][potato_crisps]" value="0"
                                                                id="PotatoCrisps-1" data-option="High" data-correct="0">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][potato_crisps]" value="1"
                                                                id="PotatoCrisps-2" data-option="Low" data-correct="1"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][potato_crisps]" value="0"
                                                                id="PotatoCrisps-3" data-option="Unsure" data-correct="0">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Salmon</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][salmon]" value="1" id="Salmon-1"
                                                                data-option="High" data-correct="1"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][salmon]" value="0" id="Salmon-2"
                                                                data-option="Low" data-correct="0"></td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][salmon]" value="0" id="Salmon-3"
                                                                data-option="Unsure" data-correct="0"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Dark chocolate</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][dark_chocolate]" value="0"
                                                                id="DarkChocolate-1" data-option="High" data-correct="0">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][dark_chocolate]" value="1"
                                                                id="DarkChocolate-2" data-option="Low" data-correct="1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][dark_chocolate]" value="0"
                                                                id="DarkChocolate-3" data-option="Unsure" data-correct="0">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Macadamia nuts</td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][macadamia_nuts]" value="1"
                                                                id="MacadamiaNuts-1" data-option="High" data-correct="1">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][macadamia_nuts]" value="0"
                                                                id="MacadamiaNuts-2" data-option="Low" data-correct="0">
                                                        </td>
                                                        <td class="text-center"><input class="form-check-input" type="radio"
                                                                name="ans[nutrition-Q-4][macadamia_nuts]" value="0"
                                                                id="MacadamiaNuts-3" data-option="Unsure" data-correct="0">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                        <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                            target="3">Back</button>
                                        <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                            target="5">Next</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card">
                                        <div class="p-3 card-header bg-white">
                                            ...
                                            <input type="hidden" name="questions[nutrition-Q-5]"
                                                value="Which of these foods has the most iron?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2">
                                                <!-- First Row -->
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="0" id="food1">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="0" id="food2">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="1" id="food3">
                                            ...
                                            <div class="row px-2">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="0" id="food4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="0" id="food5">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[nutrition-Q-5][food_most_iron]" value="0" id="food6">
                                        ...
                                        <!-- Question 6 -->
                                        <div class="p-3 card-header bg-white">
                                            <h5 class="m-0">6. Approximately how many decisions do we make every day about
                                                what we eat? </h5>
                                            <input type="hidden" name="questions[nutrition-Q-6]"
                                                value="Approximately how many decisions do we make every day about what we eat?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2 align-items-center">
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="decision1"
                                                            name="ans[nutrition-Q-6][every_day_decisions_eat]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="decision2"
                                                            name="ans[nutrition-Q-6][every_day_decisions_eat]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="decision3"
                                                            name="ans[nutrition-Q-6][every_day_decisions_eat]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="1"
                                                            data-option="Correct" data-correct="1" id="decision4"
                                                            name="ans[nutrition-Q-6][every_day_decisions_eat]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Unsure" data-correct="0" id="decision5"
                                                            name="ans[nutrition-Q-6][every_day_decisions_eat]">
                                        ...
                                        <div class="p-3 card-header bg-white">
                                            ...
                                            <input type="hidden" name="questions[nutrition-Q-7]"
                                                value="Which of the following is NOT a 'Macronutrient'?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2 align-items-center">
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="1"
                                                            data-option="Correct" data-correct="1" id="Macronutrien1"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="Macronutrien2"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                                        <label class="form-check-label"
                                                            for="Macronutrien2">Carbohydrate</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="Macronutrien3"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="Macronutrien4"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="Macronutrien5"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Unsure" data-correct="0" id="Macronutrien6"
                                                            name="ans[nutrition-Q-7][macronutrient]">
                                        ...
                                        <div class="p-3 card-header bg-white">
                                            ...
                                            <input type="hidden" name="questions[nutrition-Q-8]"
                                                value="Which of these foods has the most calcium?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2 align-items-center">
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="calciu1"
                                                            name="ans[nutrition-Q-8][most_calcium]">
                                                        <label class="form-check-label" for="calciu1">Baby spinach, 1
                                                            cup</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="1"
                                                            data-option="Correct" data-correct="1" id="calcium2"
                                                            name="ans[nutrition-Q-8][most_calcium]">
                                                        <label class="form-check-label" for="calcium2">Firm tofu,
                                                            100g</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="calciu3"
                                                            name="ans[nutrition-Q-8][most_calcium]">
                                                        <label class="form-check-label" for="calciu3">Tuna, small tin, 90
                                                            g</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="calcium4"
                                                            name="ans[nutrition-Q-8][most_calcium]">
                                                        <label class="form-check-label" for="calcium4">Almonds, 1/2
                                                            cup</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Unsure" data-correct="0" id="calcium5"
                                                            name="ans[nutrition-Q-8][most_calcium]">
                                        ...
                                        <div class="p-3 card-header bg-white">
                                            ...
                                            <input type="hidden" name="questions[nutrition-Q-9]"
                                                value="Which of these foods has the most fibre?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2 align-items-center">
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="fibre1"
                                                            name="ans[nutrition-Q-9][most_fibre]">
                                                ...
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="1"
                                                            data-option="Correct" data-correct="1" id="fibre2"
                                                            name="ans[nutrition-Q-9][most_fibre]">
                                                        <label class="form-check-label" for="fibre2">Raw oats, 1/2
                                                            cup</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="fibre3"
                                                            name="ans[nutrition-Q-9][most_fibre]">
                                                        <label class="form-check-label" for="fibre3">Cashews, 1
                                                            handful</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Wrong" data-correct="0" id="fibre4"
                                                            name="ans[nutrition-Q-9][most_fibre]">
                                                        <label class="form-check-label" for="fibre4">Broccoli, 1/2
                                                            cup</label>
                                                    </div>
                                                </div>
                                                <div class="form-floating my-3 col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="0"
                                                            data-option="Unsure" data-correct="0" id="fibre5"
                                                            name="ans[nutrition-Q-9][most_fibre]">
                                        ...
                                        <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                            <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                                target="4">Back</button>
                                            <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                                target="6">Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="step-tab-box sports-form" id="div6" style="display: none;">
                                <div class="card">
                                    <div class="p-3 card-header bg-white">
                                        <div class="d-flex align-items-center">
                                            <h5 class="m-0">1. Compared to a non-athlete, how much total protein (per day)
                                                can an athlete need?</h5>
                                            <span class="text-danger general-error-message"></span>
                                        </div>
                                        <input type="hidden" name="questions[sports-nutrition-Q-1]"
                                            value="Compared to a non-athlete, how much total protein (per day) can an athlete need?" />
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="row px-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-1]" value="0" id="protein1"
                                                            data-option="Wrong" data-correct="0">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-1]" value="1" id="protein2"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-1]" value="0" id="protein3"
                                                            data-option="Wrong" data-correct="0">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-1]" value="0" id="protein4"
                                                            data-option="Wrong" data-correct="0">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-1]" value="0" id="protein5"
                                                            data-option="Unsure" data-correct="0">
                                        ...
                                        <div class="p-3 card-header bg-white">
                                            <h5 class="m-0">2. Which of the following are signs that you are not eating
                                                enough to meet your training needs? </h5>
                                            <input type="hidden" name="questions[sports-nutrition-Q-2]"
                                                value="Which of the following are signs that you are not eating enough to meet your training needs?" />
                                        </div>
                                        <div class="row px-2">
                                            <!-- Left Column -->
                                            <div class="col-md-6">
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed1"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed2"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed3"
                                                            data-option="Correct" data-correct="1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed4"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed5"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="checkbox" value="0"
                                                            name="ans[sports-nutrition-Q-2][]" id="diagnosed6"
                                                            data-option="Unsure" data-correct="0">
                                        ...
                                        <div class="p-3 card-header bg-white">
                                            <h5 class="m-0">3. On a heavy training day (training twice a day or
                                                high-intensity workouts) which foods should be increased? </h5>
                                            <input type="hidden" name="questions[sports-nutrition-Q-3]"
                                                value="On a heavy training day (training twice a day or high-intensity workouts) which foods should be increased?" />
                                        </div>
                                        <div class="row px-2">
                                            <!-- Left Column -->
                                            <div class="col-md-6">
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="0" id="bloodTest1"
                                                            data-option="Wrong" data-correct="0">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="0" id="bloodTest2"
                                                            data-option="Wrong" data-correct="0">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="0" id="bloodTest3"
                                                            data-option="Wrong" data-correct="0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating my-3">
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="1" id="bloodTest4"
                                                            data-option="Correct" data-correct="1">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="0" id="bloodTest5"
                                                            data-option="Wrong" data-correct="0">
                                                    ...
                                                    <div class="form-check my-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="ans[sports-nutrition-Q-3]" value="0" id="bloodTest6"
                                                            data-option="Unsure" data-correct="0">
                            ...
                            <div class="step-tab-box sports-form" id="div7" style="display: none;">
                                <div class="card">
                                    <div class="card">
                                        <div class="p-3 card-header bg-white">
                                            <div class="d-flex align-items-center">
                                                <h5 class="m-0">4. What is the most important role for 'Protein' in the
                                                    body?</h5>
                                                <span class="text-danger general-error-message"></span>
                                            </div>
                                            <input type="hidden" name="questions[sports-nutrition-Q-4]"
                                                value="What is the most important role for 'Protein' in the body?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2">
                                                <!-- Question 4 -->
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest1"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="bodyTest1">Fuel for low to
                                                                moderate intensity exercise</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest2"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="bodyTest2">Fuel for
                                                                moderate to high intensity exercise</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest3"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="bodyTest3">Delivery of
                                                                oxygen to muscles</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="1" id="bodyTest4"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="bodyTest4">Muscle growth
                                                                and repair</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest5"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="bodyTest5">A healthy
                                                                digestive system</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest6"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="bodyTest6">Strong
                                                                bones</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest7"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label"
                                                                for="bodyTest7">Hydration</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[sports-nutrition-Q-4]" value="0" id="bodyTest8"
                                                                data-option="Unsure" data-correct="0">
                                            ...
                                            <!-- Question 5 -->
                                            <div class="p-3 card-header bg-white">
                                                <h5 class="m-0">5. Which of the following statements about the role of
                                                    carbohydrates is NOT correct?</h5>
                                                <input type="hidden" name="questions[sports-nutrition-Q-5]"
                                                    value="Which of the following statements about the role of carbohydrates is NOT correct?" />
                                            </div>
                                            <div class="row px-2">
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="-1" id="carbTest1"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="carbTest1">Support decision
                                                                making</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="-1" id="carbTest2"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="carbTest2">Helping maintain
                                                                competition performance levels</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="-1" id="carbTest3"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="carbTest3">Assists fuelling
                                                                and recovery from training sessions</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="1" id="carbTest4"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="carbTest4">Major factor for
                                                                gaining body fat</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="1" id="carbTest5"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="carbTest5">Increases
                                                                inflammation in the body</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-5][]" value="0" id="carbTest6"
                                                                data-option="Unsure" data-correct="0">
                                            ...
                                            <div class="p-3 card-header bg-white">
                                                ...
                                                <input type="hidden" name="questions[sports-nutrition-Q-6]"
                                                    value="What main fuels do muscles use during training?" />
                                            </div>
                                            <div class="row px-2">
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="-1" id="training1"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="training1">Protein</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="1" id="training2"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="training2">Carbs</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="1" id="training3"
                                                                data-option="Correct" data-correct="1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="-1" id="training4"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="training4">Iron</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="-1" id="training5"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="training5">Water</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-6][]" value="0" id="training6"
                                                                data-option="Unsure" data-correct="0">
                                            ...
                                            <div class="p-3 card-header bg-white">
                                                ...
                                                <input type="hidden" name="questions[sports-nutrition-Q-7]"
                                                    value="Which statements about iron are correct?" />
                                            </div>
                                            <div class="row px-2">
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-7][]" value="1" id="statement1"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="statement1">Females need
                                                                over twice the amount of iron per day as men</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-7][]" value="1" id="statement2"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="statement2">Vegetarian
                                                                athletes are higher risk of low iron as plants less iron in
                                                                the food and it's harder to absorb</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-7][]" value="1" id="statement3"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="statement3">Female athletes
                                                                are higher risk of low iron due to losing extra iron through
                                                                periods</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-7][]" value="-1"
                                                                id="statement4" data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="statement4">Iron deficiency
                                                                improves over time as the athlete matures</label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[sports-nutrition-Q-7][]" value="0" id="statement5"
                                                                data-option="Unsure" data-correct="0">
                                        ...
                                        <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                            <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                                target="6">Back</button>
                                            <button id="next" type="button" class="btn btn-primary ms-auto showStepTab"
                                                target="8">Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="step-tab-box supplement-form" id="div8" style="display: none;">
                                <div class="card">
                                    <div class="card">
                                        <div class="p-3 card-header bg-white">
                                            <div class="d-flex align-items-center">
                                                <h5 class="m-0">1. Which of the following statements about 'supplements' are
                                                    true?</h5>
                                                <span class="text-danger general-error-message"></span>
                                            </div>
                                            <input type="hidden" name="questions[supplements-Q-1]"
                                                value="Which of the following statements about 'supplements' are true?" />
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row px-2">
                                                <!-- Left Column -->
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="-1"
                                                                name="ans[supplements-Q-1][]" id="supplements1"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="-1"
                                                                name="ans[supplements-Q-1][]" id="supplements2"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="supplements2">
                                                                It is not possible to consume enough nutrients through
                                                                eating food alone (without supplements)
                                                            </label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="1"
                                                                name="ans[supplements-Q-1][]" id="supplements3"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="supplements3">
                                                                Athletes should check with a Sports Dietitian before taking
                                                                supplements
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="1"
                                                                name="ans[supplements-Q-1][]" id="supplements4"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="supplements4">
                                                                Eating a wide range of foods provides most athletes with the
                                                                vitamins and minerals they need
                                                            </label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="-1"
                                                                name="ans[supplements-Q-1][]" id="supplements5"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="supplements5">
                                                                Most supplements available in Australia are safe for
                                                                athletes to use
                                                            </label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox" value="0"
                                                                name="ans[supplements-Q-1][]" id="supplements6"
                                                                data-option="Unsure" data-correct="0">
                                            ...
                                            <div class="p-3 card-header bg-white">
                                                ...
                                                <input type="hidden" name="questions[supplements-Q-2]"
                                                    value="When choosing a supplement, you should?" />
                                            </div>
                                            <div class="row px-2">
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="-1" id="athletes1"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="-1" id="athletes2"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="1" id="athletes3"
                                                                data-option="Correct" data-correct="1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="-1" id="athletes4"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="-1" id="athletes5"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="radio"
                                                                name="ans[supplements-Q-2]" value="0" id="athletes6"
                                                                data-option="Unsure" data-correct="0">
                                            ...
                                            <!-- Question 3 -->
                                            <div class="p-3 card-header bg-white">
                                                <h5 class="m-0">3. Regarding vitamin and minerals supplements, which
                                                    statements are true?</h5>
                                                <input type="hidden" name="questions[supplements-Q-3]"
                                                    value="Regarding vitamin and minerals supplements, which statements are true?" />
                                            </div>
                                            <div class="row px-2">
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[supplements-Q-3][]" value="-1" id="vitamin1"
                                                                data-option="Wrong" data-correct="0">
                                                        ...
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[supplements-Q-3][]" value="1" id="vitamin2"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="vitamin2">
                                                                Can assist athletes to correct a deficiency diagnosed by a
                                                                Medical professional
                                                            </label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[supplements-Q-3][]" value="-1" id="vitamin3"
                                                                data-option="Wrong" data-correct="0">
                                                            <label class="form-check-label" for="vitamin3">
                                                                Vegetarians and vegans are not at risk of vitamin and
                                                                mineral deficiences
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating my-3">
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[supplements-Q-3][]" value="1" id="vitamin4"
                                                                data-option="Correct" data-correct="1">
                                                            <label class="form-check-label" for="vitamin4">
                                                                May be recommended for international competition where food
                                                                variety is limited
                                                            </label>
                                                        </div>
                                                        <div class="form-check my-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="ans[supplements-Q-3][]" value="0" id="vitamin5"
                                                                data-option="Unsure" data-correct="0">
                                        ...
                                        <div class="bg-white text-end py-3 card-footer d-flex px-4">
                                            <button id="prev" type="button" class="btn btn-secondary me-auto showStepTab"
                                                target="7">Back</button>
                                            <button id="next" type="button"
                                                class="btn btn-primary ms-auto submit-free-test">Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="score-meter-box">
                                                ...
                                                <div class="score-meter-box-frame">
                                                    <svg version="1.1" x="0px" y="0px" viewBox="0 0 500 243"
                                                        style="enable-background:new 0 0 500 243;" xml:space="preserve">
                                                        <path
                                                ...
                                                <span class="meter-arrow nutrition-result"
                                                    ...
                                                    <svg version="1.1" x="0px" y="0px" viewBox="0 0 133 22"
                                                        style="enable-background:new 0 0 133 22;" xml:space="preserve">
                                                        <path
                                        ...
                                        <div class="col-lg-6">
                                            <div class="score-meter-main score-meter-locked supplement-plan">
                                                <div class="score-meter-box score-meter-out score-meter-box-3">
                                                    ...
                                                    <span class="meter-arrow supplement-result"
                                                ...
                                                <span class="score-lock">
                                                    <svg class="score-lock-ico" version="1.1" x="0px" y="0px"
                                                    ...
                                                    <svg class="score-unlock-ico" version="1.1" x="0px" y="0px"
                                                        viewBox="0 0 800 800" style="enable-background:new 0 0 800 800;"
                                                        xml:space="preserve">
                                                        <g>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="score-meter-main score-meter-locked sport-plan">
                                                <div class="score-meter-box score-meter-out score-meter-box-2">
                                                    ...
                                                    <span class="meter-arrow sport-result"
                                                        style="transform: rotate(120deg);">
                                                        <svg version="1.1" x="0px" y="0px" viewBox="0 0 133 22"
                                                            style="enable-background:new 0 0 133 22;" xml:space="preserve">
                                                            <path
                                            ...
                                            <div class="card-body p-4">
                                                <div class="p-md-3 row align-items-center">
                                                    <div class="col-lg-7">
                                                        ...
                                                        <p>Displays the nutrition or fitness plan a subscribed to, including
                                                            details on duration, customization options, and renewal status.
                                                            Helps manage their plan effectively.</p>
                                                        <a href="{{ route('front.sub-home-page') }}#sport-plans"
                                                            class="btn btn-white" target="_blank">Purchase Plan
                                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M6.4165 15.5827L15.5832 6.41602M15.5832 6.41602H6.4165M15.5832 6.41602V15.5827"
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="">
                                                            <figure class="m-auto" style="max-width: inherit;">
                                                                <img src="{!! frontAssets('images/purchase-plan-image.webp') !!}"
                                                                    class="img-fluid" alt="">
                                                            </figure>
                                                            <!-- <div class="kerry-info">
                                                                <h5>Kerry O'Bryan</h5>
                                            ...
                                            <div class="card-body p-4">
                                                <div class="p-md-3 row align-items-center">
                                                    <div class="col-lg-7">
                                                        ...
                                                        <p>Personalised nutrition and fitness plans to help you stay strong,
                                                            energised, and at your best every day.</p>
                                                        <a href="{{ route('front.sub-home-page') }}#sample-plan-section"
                                                            class="btn btn-white" target="_blank">Sample Plan
                                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M6.4165 15.5827L15.5832 6.41602M15.5832 6.41602H6.4165M15.5832 6.41602V15.5827"
                                            ...
                                            <div class="card-body p-4">
                                                <div class="p-md-3 row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <h3>Get answers from a real-life expert. Not a chat bot.</h3>
                                                        <a href="https://booking.biohealthpassport.com.au/kerry-obryan"
                                                            class="btn btn-white" target="_blank">Book Now
                                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M6.4165 15.5827L15.5832 6.41602M15.5832 6.41602H6.4165M15.5832 6.41602V15.5827"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="kerry-info-box">
                                                            <figure>
                                                                <img src="https://booking.biohealthpassport.com.au/public/uploads/hero01.webp"
                                                                    alt="" class="img-fluid">
                                                            </figure>
                                                            <div class="kerry-info">
                                                                <h5>Kerry O'Bryan</h5>
                                                                <p>MNutr&amp;Diet, B.Sp.Ex.Sc, IOC Dip Nut</p>
                                                                <p>(Dietitian /Sports Scientist/Strength &amp; Conditioning
                                                                    Coach)</p>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close detail-modal-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="detailsForm">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>We'd love to send you some nutrition information specific to your sport. Please enter your
                            details below:</p>
        ...
        <!-- Modal Structure -->
        <div class="modal show" id="forgotPasswordModal" tabindex="-1" aria-labelledby="forgotPasswordModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
