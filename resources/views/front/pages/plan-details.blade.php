                                                    ...
                                                    <div class="challenge-cards horizontal-scroll"
                                                        ...
                                                        @foreach ($meals as $meal)
                                                            <div class="challenge-card clickable"
                                                                ...
                                                                <div class="">
                                                                    <h3>{{ $meal->meal->title }}<span
                                                                            class="smart-swap-btn"
                                                                            style="background-color:#649EF7; color:#fff; padding:10px;font-size:14px;display:inlin-block;margin-top:4px;margin-left:4px;">
