            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#recipeDialogModal .modal-body .nutrition-info').html(`
                         ...
                         <span style="color: #8cc900">● <span style="color:rgba(59, 59, 59, 1)">Energy: ${response.totalEnergy ?? 0} kJ</span></span><br>
                      <span style="color: #eb4c60">● <span style="color:rgba(59, 59, 59, 1)">Protein: ${response.totalProtein ?? 0} g</span></span><br>
                         <span style="color: #f1b020">● <span style="color:rgba(59, 59, 59, 1)">Carb: ${response.totalCarbs ?? 0} g</span></span><br>
                         <span style="color: #659cf1">● <span style="color:rgba(59, 59, 59, 1)">Fat: ${response.totalFats ?? 0} g</span></span>
                    `);
