...
<main class="main">
    ...
    <script>
        ...
        $(document).on('click', '.smart-swap-btn', function () {
                        ...
                        if (data.items && data.items.length > 0) {
                            $.each(data.items, function (index, item) {
                                ...
                                const swapButton = item.swapItems && item.swapItems.length > 0
                                    ? `<button class="d-flex align-items-center m-1 py-2 rounded-pill item-swap-btn btn-swap btn btn-primary" data-bs-toggle="modal" data-bs-target="#subcategoryItemsModal3" data-item-id="${item.id}" data-item-name="${item.name}" data-user-item-id="${item.user_item_id}" data-user-meal-id="${item.user_meal_id}" data-user-plan-id="${user_plan_id}" data-sub-category-id="${user_sub_category_id}" data-user-category-id="${user_category_id}">
            ...
            //                     <button class="btn-outline-secondary smart-swap-btn btn btn-sm">
            ...
            //             html += `
            //                 <div class="d-flex align-items-start mb-3 swap-item">
            //                     <img src="${swap.image}" alt="${swap.title}" class="me-3 swap-item-img" style="width: 60px; height: 60px; object-fit: cover; border-radius: 5px;" />
            //                     <div class="flex-grow-1">
            //                         <div class="swap-item-name fw-bold">${swap.title}</div>
            //                     </div>
            //                     <div class="d-flex flex-column align-items-end swap-item-actions">
            //                         <button class="mb-2 btn-outline-primary btn btn-sm">
