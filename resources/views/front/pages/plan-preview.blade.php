...
<head>
    ...
    <style>
        ...
        *:before, *:after { -webkit-box-sizing: border-box; -moz-box-sizing: border-box; -o-box-sizing: border-box; -ms-box-sizing: border-box; box-sizing: border-box; }
        ...
        .card-box h6 { margin-bottom: 0.35rem; font-size:12px;}
        h5{font-size:14px;}
        li.pl-2,p{font-size:12px;}
        .colored-span{font-size:12px;}
                ...
                @if($hasMeals)
                    ...
                    @foreach ($groupedMeals as $subCategoryId => $mealsGroup)
                        ...
                        @foreach ($mealsGroup as $userMeal)
                            ...
                            <div class="meal-block-page-break" style="page-break-inside: avoid; margin-bottom: 20px;">
                                <h5 class="mt-20 mb-3 text-primary">
                                        ...
                                        <div class="col-xl-9">
                                            <div class="row g-4">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="d-flex flex-wrap mt-4 text-slate-700 colored-span">
