                ...
                <div
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <a type="button" href="{{ route('admin.dashboard') }}"
                            class="btn btn-primary btn-set-task w-sm-100">Back</a>&nbsp;
                    </div>
                </div>
            </div>
        </div>
        <div class="row align-item-center">
            <div class="col-md-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
						<form id="admin-user-profile-form" method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
							@csrf
                            ...
                            <div class="accordion" id="userInfoAccordion">
                                            ...
                                            <div class="row mt-1 g-3 align-items-center">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="business_name"
                                                        value="{{ old('business_name', $adminUser->business_name ?? '') }}"
                                                        id="business_name">
                                            ...
                                            <div class="row mt-1 g-3 align-items-center">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="designation"
                                                        value="{{ old('designation', $adminUser->designation ?? '') }}"
                                                        id="last_name">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="file" class="form-control" name="profile_image"
                                                        value="{{ old('profile_image', $adminUser->profile_image ?? '') }}"
                                                        id="profile_image" accept="image/*">
                                                    <img class="avatar lg rounded-circle img-thumbnail"
                                                        src="{{ $adminUser->profile_image ? uploadAssets($adminUser->profile_image) : 'https://booking.biohealthpassport.com.au/public/admin/dist/assets/images/profile_av.svg' }}"
                                                        alt="profile">
                                                    <!-- Conditionally show the Remove Image button -->
                                                    @if (!empty($adminUser->profile_image))
                                                        <a type="button"
                                                            href="{{ route('admin.profile.remove-image', $adminUser->id) }}"
                                                            class="btn btn-primary btn-set-task w-sm-100">Remove Image</a>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="row mt-1 g-3 align-items-center">
                                                <div class="col-md-6">
                                                    <label for="qualification_text" class="form-label">Qualification
                                                        Text</label>
                                                    <textarea class="form-control" name="qualification_text"
                                                        id="qualification_text">{{ old('qualification_text', $adminUser->qualification_text ?? '') }}</textarea>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingModuleConfig">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseModuleConfig" aria-expanded="false"
                                            aria-controls="collapseModuleConfig">
                                            Module Configurations
                                        </button>
                                    </h2>
                                    <div id="collapseModuleConfig" class="accordion-collapse collapse"
                                        aria-labelledby="headingModuleConfig" data-bs-parent="#userInfoAccordion">
                                        <div class="accordion-body">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-md-6">
                                                    <label for="email_signature" class="form-label">Email Signature</label>
                                                    <textarea class="form-control" name="email_signature"
                                                        id="email_signature">{{ old('email_signature', $adminUser->email_signature ?? '') }}</textarea>
                                                    @include('backend.layouts.error', ['field' => 'email_signature'])
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="description_character_count" class="form-label">(i)
                                                        Information hover count</label>
                                                    <input type="text" class="form-control"
                                                        name="description_character_count"
                                                        value="{{ old('description_character_count', $adminUser->description_character_count ?? '') }}"
                                                        id="description_character_count">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFrontConfig">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseFrontConfig" aria-expanded="false"
                                            aria-controls="collapseFrontConfig">
                                            Configuration of Front Booking Page
                                        </button>
                                    </h2>
                                    <div id="collapseFrontConfig" class="accordion-collapse collapse"
                                        aria-labelledby="headingFrontConfig" data-bs-parent="#userInfoAccordion">
                                        <div class="accordion-body">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-md-6">
                                                    <label for="front_logo" class="form-label">Front Page Logo</label>
                                                    <input type="file" class="form-control" name="front_logo"
                                                        value="{{ old('front_logo', $adminUser->front_logo ?? '') }}"
                                                        id="front_logo" accept="image/*">
                                                    <img class="avatar lg rounded-circle img-thumbnail"
                                                    ...
                                                    @if (!empty($adminUser->front_logo))
                                                        <a type="button" href="{{ route('admin.profile.remove-logo', $adminUser->id) }}"
                                                            class="btn btn-primary btn-set-task w-sm-100">Remove Image</a>
                                                    @endif
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="file" class="form-control" name="about_us_image"
                                                        value="{{ old('about_us_image', $adminUser->about_us_image ?? '') }}"
                                                        id="about_us_image" accept="image/*">
                                                    <img class="avatar lg rounded-circle img-thumbnail"
                                                    ...
                                                    @if (!empty($adminUser->about_us_image))
                                                        <a type="button"
                                                            href="{{ route('admin.profile.remove-about-us', $adminUser->id) }}"
                                                            class="btn btn-primary btn-set-task w-sm-100">Remove Image</a>
                                                    @endif
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="front_title"
                                                        value="{{ old('front_title', $adminUser->front_title ?? '') }}"
                                                        id="front_title">
                                                    @include('backend.layouts.error', ['field' => 'front_title'])
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="front_description" class="form-label">Front
                                                        Description</label>
                                                    <textarea class="form-control" name="front_description"
                                                        id="front_description">{{ old('front_description', $adminUser->front_description ?? '') }}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="about_us_title"
                                                        value="{{ old('about_us_title', $adminUser->about_us_title ?? '') }}"
                                                        id="last_name">
                                                    @include('backend.layouts.error', ['field' => 'about_us_title'])
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="about_us_description" class="form-label">About Us
                                                        Description</label>
                                                    <textarea class="form-control" name="about_us_description"
                                                        id="about_us_description">{{ old('about_us_description', $adminUser->about_us_description ?? '') }}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="copyright_text"
                                                        value="{{ old('copyright_text', $adminUser->copyright_text ?? '') }}"
                                                        id="copyright_text">
