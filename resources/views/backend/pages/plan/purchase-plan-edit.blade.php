...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.meal-time-checkbox').each(function() {
            ...
            mealSelect.on('select2:unselect', function(e) {
                ...
                $.ajax({
                    url: '{{ route("admin.purchase-plans.remove-user-meal") }}',
                    method: 'POST',
                    data: {
                        user_id: userId,
                        meal_id: mealId,
        ...
        $('#saveMealFood').on('click', function () {
            ...
            $.ajax({
                url: '{{ route("admin.purchase-plans.add-food") }}',
                type: 'POST',
                data: {
                    item_id: foodId,
                    meal_ids: meals,
        ...
        function updateFoodCount(foodId, change, color = null, title = null, category_id = null) {
            $.ajax({
                url: '{{ route("admin.items.get-food-details") }}?food_id=' + foodId,
                method: 'GET',
                success: function(response) {
                    if (response.item) {
        ...
        $('#saveItemChanges').on('click', function () {
            ...
            $.ajax({
                url: '{{ route("admin.purchase-plans.update-food-swap-foods") }}',
                method: 'POST',
                data: {
                    item_id: itemId,
                    meal_id: mealId,
    ...
    $(document).on('change', '.editable-meal-name', function() {
        ...
        $.ajax({
            url: '{{ route("admin.meals.update-name") }}',
            method: 'POST',
            data: {
                meal_id: mealId,
                user_id: userId,
    ...
    $(document).ready(function() {
        ...
        function performSearch(mealId, mealTimeId, userId, planId) {
            ...
            if (searchType === 'system') {
                ...
                $.ajax({
                    url: '{{ route("admin.product.search") }}', // Use route for Woolworths search
                    type: 'GET',
                    data: {
                        query: query
                    },
    ...
    $(document).ready(function () {
        $('#nutritionToggle').on('change', function () {
            ...
            $.ajax({
                url: '{{ route("admin.purchase-plans.update-nutrition-flag") }}', // Your Laravel route
                method: 'POST',
                data: {
