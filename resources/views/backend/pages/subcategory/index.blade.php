    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div class="card-header pb-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom">
                ...
                <a href="{{ route('admin.subcategories.create') }}" class="btn btn-primary py-2 px-2 btn-set-task">
                    ...
                    <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($category->image)
                                    <img src="{{ webAssets('storage/' . $category->image) }}" alt="" width="50">
                                    @else
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        <a href="{{ route('admin.subcategories.edit', $category->id) }}" class="btn btn-outline-secondary">
                                            <i class="icofont-edit text-success"></i>
                                        </a>
                                        <form action="{{ route('admin.subcategories.destroy', $category->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
