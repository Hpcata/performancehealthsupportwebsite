					...
					<div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
						<div class="card border-0 w280">
							...
							<div class="list-group m-2 ">
								<a href="{!! route('backend.admin-profile', ['id' => Auth::user()->id ?? 3 ]) !!}" class="list-group-item list-group-item-action border-0 "><i class="icofont-ui-file fs-5 me-3"></i>Profile Page</a>
