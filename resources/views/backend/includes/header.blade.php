		...
		<div class="container-xxl">
			...
			<div class="h-right d-flex align-items-center order-1">
				...
				<div class="dropdown user-profile ms-3 d-flex align-items-center zindex-popover">
					...
					src="{{ isset(Auth::guard('admin')->user()->profile_image) ? getAdminProfileImage() : 'https://booking.biohealthpassport.com.au/public/admin/dist/assets/images/profile_av.svg' }}" 
					alt="profile">
					</a>
						...
						<div class="card border-0 w280">
							<div class="card-body pb-0">
								<div class="d-flex py-1">
									<img class="avatar rounded-circle" src="{{ isset(Auth::guard('admin')->user()->profile_image) ? getAdminProfileImage() : 'https://booking.biohealthpassport.com.au/public/admin/dist/assets/images/profile_av.svg' }}" alt="profile">
